...
To see it in action, visit [the plugin's homepage](http://www.viper007bond.com/wordpress-plugins/battlefield-2-stats/ "You'll find the output in the sidebar, down a little bit").

== Installation ==

Extract all files from the ZIP file, making sure to keep the file structure intact. Then upload the `wp_bf2s` folder to `/wp-content/plugins/`.
